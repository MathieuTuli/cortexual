...
export const VIDEO_EMBEDDINGS_FILE = path.join(DATA_DIR, 'video-embeddings.json')
...
export function ensureStore() {
  ...
  if (!fs.existsSync(VIDEO_EMBEDDINGS_FILE)) fs.writeFileSync(VIDEO_EMBEDDINGS_FILE, '{}')
